...
const Navbar = () => {
  ...
  return (
    <motion.nav
      className={`fixed w-full px-5 py-12 md:px-10 flex items-center justify-center h-[70px] md:h-20 z-50 transition-colors duration-500 ${ onTop ? "bg-black/60" : "bg-black" }`}
      variants={{
        visible: { y: 0 },
        hidden: { y: "-100%" },
      }}
