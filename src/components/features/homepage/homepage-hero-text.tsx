...
const HomepageHeroText = () => {
  return (
    <div className="w-full justify-center bg-black/50 items-center lg:items-start text-center lg:text-left absolute inset-0 text-white flex flex-col h-full z-10 px-8 gap-4 xl:pl-64 lg:px-16">
      <motion.p
